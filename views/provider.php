...
?>
	<header>
		<div style="float:right"><a target="_blank" href="/rss/by/provider_uuid/<?=$provider_uuid?>/?limit=15"><img src="/img/feed-icon-28x28.png"></a></div>
		<h2><?=$provider['name']?> datasets</h2>
	</header>
	<article>
